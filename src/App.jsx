...
const FormattedText = ({ text, className = "" }) => {
    ...
    const processText = (str) => {
        ...
        let processed = str
            // Fix LaTeX bolding \textbf{...} -> <strong>...</strong>
            .replace(/\\textbf\{([^}]+)\}/g, '<strong>$1</strong>')
            // Fix LaTeX text \text{...} -> ...
            .replace(/\\text\{([^}]+)\}/g, '$1')
            // Fix Markdown bolding **...** -> <strong>...</strong>
...
const generateContent = async (apiKey, prompt, context, systemInstruction, attachmentData = null) => {
    ...
    const fullSystemPrompt = `
        ...
        4. Use MARKDOWN for text formatting (e.g. **bold**, *italics*) instead of LaTeX commands like \\textbf.
        5. Use LaTeX ONLY for mathematical formulas enclosed in $.
    `;
